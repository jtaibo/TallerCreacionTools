...
class PipelineCheck():
    ...
    def __init__(self): 
        ...
        self.data["multipleValues"] = (ConditionChecker(name = "multipleValues",displayName="Multiple shapes",toolTip="No transform node can contain multiple shape nodes."))
        ...
        self.data["scales"] = (ConditionChecker(name = "scales",displayName="Scales",toolTip="Scales = 1"))
